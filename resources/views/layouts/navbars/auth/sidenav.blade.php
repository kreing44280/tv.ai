        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}"
                    ...
                    <div
                        class="me-2 icon icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                ...
                href="{{ route('news') }}">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-newspaper" viewBox="0 0 16 16" stroke="#fb6340">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'members') == true ? 'active' : '' }}"
                    href="{{ route('members') }}">
                    <div
                        class="me-2 icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
